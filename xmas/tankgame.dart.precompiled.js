...
Target_onPrepareRender_closure: {"": "Closure;this_0",
  call$1: function(canvas) {
    this.this_0.sp.render$1(canvas);
  },
  $is_args1: true
},
...
function dart_precompiled($collectedClasses) {
  ...
  function GEng(_screen, _rect, objlist, canvas, backcanvas, imageMap, soundManager, _scale, frameWatch, cpucnt, rand, _repaintCount) {
  ...
  function SoundManager(_map, soundOn, mediaType) {
    this._map = _map;
  ...
  function SoundManager_put_closure(box_0, key_1, comp_2) {
    this.box_0 = box_0;
    this.key_1 = key_1;
    this.comp_2 = comp_2;
  }
  ...
  function SoundManager_put_closure0(comp_3) {
    this.comp_3 = comp_3;
  }
  ...
  function XMasSaveData(hiscores, rankHistory) {
    this.hiscores = hiscores;
    this.rankHistory = rankHistory;
  }
  XMasSaveData.builtin$cls = "XMasSaveData";
  if (!"name" in XMasSaveData)
    XMasSaveData.name = "XMasSaveData";
  $desc = $collectedClasses.XMasSaveData;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XMasSaveData.prototype = $desc;
  function XMasSaveData_build_closure(this_0) {
    this.this_0 = this_0;
  }
  XMasSaveData_build_closure.builtin$cls = "XMasSaveData_build_closure";
  if (!"name" in XMasSaveData_build_closure)
    XMasSaveData_build_closure.name = "XMasSaveData_build_closure";
  $desc = $collectedClasses.XMasSaveData_build_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XMasSaveData_build_closure.prototype = $desc;
  function XMasSaveData_build_closure0(this_1) {
    this.this_1 = this_1;
  }
  XMasSaveData_build_closure0.builtin$cls = "XMasSaveData_build_closure0";
  if (!"name" in XMasSaveData_build_closure0)
    XMasSaveData_build_closure0.name = "XMasSaveData_build_closure0";
  $desc = $collectedClasses.XMasSaveData_build_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XMasSaveData_build_closure0.prototype = $desc;
  function XMasSaveData_putAndWrite_closure() {
  }
  XMasSaveData_putAndWrite_closure.builtin$cls = "XMasSaveData_putAndWrite_closure";
  if (!"name" in XMasSaveData_putAndWrite_closure)
    XMasSaveData_putAndWrite_closure.name = "XMasSaveData_putAndWrite_closure";
  $desc = $collectedClasses.XMasSaveData_putAndWrite_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XMasSaveData_putAndWrite_closure.prototype = $desc;
  function XMasScore(hit, _fire, _stageLength, _stageID, _datetime) {
    this.hit = hit;
    this._fire = _fire;
    this._stageLength = _stageLength;
    this._stageID = _stageID;
    this._datetime = _datetime;
  }
  XMasScore.builtin$cls = "XMasScore";
  if (!"name" in XMasScore)
    XMasScore.name = "XMasScore";
  $desc = $collectedClasses.XMasScore;
  if ($desc instanceof Array)
    $desc = $desc[1];
  XMasScore.prototype = $desc;
  XMasScore.prototype.get$hit = function() {
    return this.hit;
  };
  ...
  function TankGame_onEndOfStage_closure(box_0, score_1) {
    this.box_0 = box_0;
  ...
  function TankGame_onEndOfStage_closure0(box_0, _numberOfHit_2, score_3) {
    this.box_0 = box_0;
    this._numberOfHit_2 = _numberOfHit_2;
  ...
  function TankGame_onEndOfStage__closure2(_numberOfHit_4, score_5) {
    this._numberOfHit_4 = _numberOfHit_4;
  ...
  function TankGame_onEndOfStage_closure1(box_0, _numberOfFire_6) {
    this.box_0 = box_0;
    this._numberOfFire_6 = _numberOfFire_6;
  }
  ...
  function TankGame_onEndOfStage_closure2(box_0, score_7) {
    this.box_0 = box_0;
  ...
  function TankGame_onEndOfStage__closure1(score_8) {
  ...
  function StageSelect_onStart_closure2() {
  }
  ...
  function StageSelect_onStart_closure3(bgColor_0, borderColor_1) {
    this.bgColor_0 = bgColor_0;
    this.borderColor_1 = borderColor_1;
  }
  StageSelect_onStart_closure3.builtin$cls = "StageSelect_onStart_closure3";
  if (!"name" in StageSelect_onStart_closure3)
    StageSelect_onStart_closure3.name = "StageSelect_onStart_closure3";
  $desc = $collectedClasses.StageSelect_onStart_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StageSelect_onStart_closure3.prototype = $desc;
  function RecordScreen(_renderList, btnList, onProcess, onFrontRender, onBackRender, onMoveOut) {
    this._renderList = _renderList;
    this.btnList = btnList;
    this.onProcess = onProcess;
    this.onFrontRender = onFrontRender;
  ...
  RecordScreen.builtin$cls = "RecordScreen";
  if (!"name" in RecordScreen)
    RecordScreen.name = "RecordScreen";
  $desc = $collectedClasses.RecordScreen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RecordScreen.prototype = $desc;
  function RecordScreen_onStart_closure() {
  }
  RecordScreen_onStart_closure.builtin$cls = "RecordScreen_onStart_closure";
  if (!"name" in RecordScreen_onStart_closure)
    RecordScreen_onStart_closure.name = "RecordScreen_onStart_closure";
  $desc = $collectedClasses.RecordScreen_onStart_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RecordScreen_onStart_closure.prototype = $desc;
  function RecordScreen_onStart_closure0(this_0) {
    this.this_0 = this_0;
  }
  RecordScreen_onStart_closure0.builtin$cls = "RecordScreen_onStart_closure0";
  if (!"name" in RecordScreen_onStart_closure0)
    RecordScreen_onStart_closure0.name = "RecordScreen_onStart_closure0";
  $desc = $collectedClasses.RecordScreen_onStart_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RecordScreen_onStart_closure0.prototype = $desc;
  function RecordScreen_onStart__closure(r_1) {
    this.r_1 = r_1;
  }
  RecordScreen_onStart__closure.builtin$cls = "RecordScreen_onStart__closure";
  if (!"name" in RecordScreen_onStart__closure)
    RecordScreen_onStart__closure.name = "RecordScreen_onStart__closure";
  $desc = $collectedClasses.RecordScreen_onStart__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RecordScreen_onStart__closure.prototype = $desc;
  function RecordScreen_onStart_closure1() {
  }
  RecordScreen_onStart_closure1.builtin$cls = "RecordScreen_onStart_closure1";
  if (!"name" in RecordScreen_onStart_closure1)
    RecordScreen_onStart_closure1.name = "RecordScreen_onStart_closure1";
  $desc = $collectedClasses.RecordScreen_onStart_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RecordScreen_onStart_closure1.prototype = $desc;
  function RecordScreen_onStart_closure2(bgColor_2, borderColor_3) {
    this.bgColor_2 = bgColor_2;
    this.borderColor_3 = borderColor_3;
  }
  RecordScreen_onStart_closure2.builtin$cls = "RecordScreen_onStart_closure2";
  if (!"name" in RecordScreen_onStart_closure2)
    RecordScreen_onStart_closure2.name = "RecordScreen_onStart_closure2";
  $desc = $collectedClasses.RecordScreen_onStart_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RecordScreen_onStart_closure2.prototype = $desc;
